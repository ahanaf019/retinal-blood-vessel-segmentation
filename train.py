...
from metrics_1 import dice_loss, dice_coef, iou
...
def load_data(path):
    x = sorted(glob(os.path.join(path, 'image', '*.bmp')))
...
if __name__ == '__main__':
    ...
    # model.compile(loss=dice_loss, optimizer=Adam(lr), metrics=[dice_coef, iou, recall_score(), precision_score()])
